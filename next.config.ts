...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_FEISHU_TABLE_CASH_FLOW: process.env.FEISHU_TABLE_CASH_FLOW || process.env.NEXT_PUBLIC_FEISHU_TABLE_CASH_FLOW || '',
    ...
    NEXT_PUBLIC_FEISHU_TABLE_FINANCE: process.env.FEISHU_TABLE_FINANCE || process.env.NEXT_PUBLIC_FEISHU_TABLE_FINANCE || '',
